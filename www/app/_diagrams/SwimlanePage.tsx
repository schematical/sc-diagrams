...
import {ButtonGroup, Container, Form, Navbar, Overlay, Toast, ToastContainer} from 'react-bootstrap';
    ...
    */
    ...
    return (
        <div>
            ...
            <Offcanvas show={showMenu()} onHide={() => setState({...state, menuMode: 'none', selectedMapFlowEvent: undefined, selectedMapFlowEventInteraction: undefined })} placement='start'>
